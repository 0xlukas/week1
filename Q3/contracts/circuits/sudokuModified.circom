...
component rangeproofs[9][9][2];
    ...
    for (var i=0; i<9; i++) {
        for (var j=0; j<9; j++) {
           ...
           rangeproofs[i][j][0].in <== puzzle[i][j];
           rangeproofs[i][j][0].range[0] <== 0;
           rangeproofs[i][j][0].range[1] <== 9;
           rangeproofs[i][j][0].out === 1;

           rangeproofs[i][j][1]=RangeProof(252);
           rangeproofs[i][j][1].in <== solution[i][j];
           rangeproofs[i][j][1].range[0] <== 0;
           rangeproofs[i][j][1].range[1] <== 9;
           rangeproofs[i][j][1].out === 1;
